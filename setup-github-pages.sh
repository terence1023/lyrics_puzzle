...
echo ""
echo "  2. 点击顶部的 ${YELLOW}Settings${NC} (设置) 标签"
echo ""
echo "  3. 左侧菜单向下滚动，找到 ${YELLOW}Pages${NC} 并点击"
echo ""
echo "  4. 在 ${YELLOW}Source${NC} 下拉菜单中选择:"
echo -e "     ${GREEN}✓ GitHub Actions${NC} ${YELLOW}← 选择这个${NC}"
echo -e "     ${RED}✗ Deploy from a branch${NC} ${YELLOW}← 不要选这个${NC}"
echo ""
echo "  5. 页面自动保存，等待 1-2 分钟部署完成"
echo ""
echo -e "${BLUE}💡 关于 'There are no verified domains' 提示:${NC}"
echo "  • 这是正常提示，可以忽略"
echo "  • 不影响 GitHub Pages 的基本使用"
echo "  • 只在使用自定义域名时才需要关注"
echo ""
echo -e "${BLUE}📖 详细配置图文教程：${NC}"
echo "  查看 GITHUB-PAGES-配置详解.md 文件"
echo ""
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
...
echo "  • 后续更新代码: ./deploy-github.sh '更新说明'"
echo "  • 配置详解文档: cat GITHUB-PAGES-配置详解.md"
echo ""
